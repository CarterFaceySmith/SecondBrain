A build system is a collection of tools and utilities that automate the process of compiling (See [[Compiler]]),  (See [[Linkers]]), and executing source code files in a project.
